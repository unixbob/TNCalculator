...
extern void *mono_aot_module_EbbAndFlow_iOS_info;
...
extern void *mono_aot_module_Syncfusion_SfChart_XForms_iOS_info;
extern void *mono_aot_module_Syncfusion_SfChart_XForms_info;
...
extern void *mono_aot_module_Syncfusion_SfTabView_XForms_iOS_info;
extern void *mono_aot_module_Syncfusion_SfTabView_XForms_info;
extern void *mono_aot_module_Syncfusion_Core_XForms_iOS_info;
extern void *mono_aot_module_EbbAndFlow_info;
...
extern void *mono_aot_module_Facebook_ShareKit_info;
extern void *mono_aot_module_Facebook_CoreKit_info;
extern void *mono_aot_module_Facebook_LoginKit_info;
extern void *mono_aot_module_Plugin_GoogleClient_info;
...
{
	mono_aot_register_module (mono_aot_module_EbbAndFlow_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_Syncfusion_SfChart_XForms_iOS_info);
	mono_aot_register_module (mono_aot_module_Syncfusion_SfChart_XForms_info);
	...
	mono_aot_register_module (mono_aot_module_Syncfusion_SfTabView_XForms_iOS_info);
	mono_aot_register_module (mono_aot_module_Syncfusion_SfTabView_XForms_info);
	mono_aot_register_module (mono_aot_module_Syncfusion_Core_XForms_iOS_info);
	mono_aot_register_module (mono_aot_module_EbbAndFlow_info);
	...
	mono_aot_register_module (mono_aot_module_Facebook_ShareKit_info);
	...
	mono_aot_register_module (mono_aot_module_Plugin_GoogleClient_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("Syncfusion.SfChart.XForms.iOS.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("Syncfusion.SfTabView.XForms.iOS.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	...
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("Plugin.GoogleClient.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "EbbAndFlow.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
